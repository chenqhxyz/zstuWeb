<template>
  <transition name="b-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      ...
      class="b-picker-panel b-date-range-picker"
      :class="[{
          ...
          <div class="b-picker-panel__content b-date-range-picker__content is-left">
            <div class="b-date-range-picker__header">
              <button
                type="button"
                @click="prevYear"
                class="b-picker-panel__icon-btn b-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="prevMonth"
                class="b-picker-panel__icon-btn b-icon-arrow-left"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="b-picker-panel__content b-date-range-picker__content is-right">
            <div class="b-date-range-picker__header">
              <button
                type="button"
                @click="nextYear"
                class="b-picker-panel__icon-btn b-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="nextMonth"
                class="b-picker-panel__icon-btn b-icon-arrow-right"></button>
              <div>{{ rightLabel }}</div>
            </div>
            <date-table
              selection-mode="range"
...
<script>
  ...
  export default {
    ...
    components: { TimePicker, DateTable, BInput }
  };
</script>
