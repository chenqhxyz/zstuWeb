<template>
  <transition name="b-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      ...
      class="b-picker-panel b-date-picker"
      :class="[{
      ...
      <div class="b-picker-panel__body-wrapper">
        ...
        <div class="b-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="b-picker-panel__shortcut"
        ...
        <div class="b-picker-panel__body">
          ...
          <div class="b-date-picker__header" v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              class="b-picker-panel__icon-btn b-date-picker__prev-btn b-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              v-show="currentView === 'date'"
              class="b-picker-panel__icon-btn b-date-picker__prev-btn b-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              class="b-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              class="b-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{`${ month + 1 } 月`}}</span>
            <button
              type="button"
              @click="nextYear"
              class="b-picker-panel__icon-btn b-date-picker__next-btn b-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              v-show="currentView === 'date'"
              class="b-picker-panel__icon-btn b-date-picker__next-btn b-icon-arrow-right">
            </button>
          </div>
      ...
      <div
        class="b-picker-panel__footer"
        v-show="footerVisible && currentView === 'date'">
        <a
          href="JavaScript:"
          class="b-picker-panel__link-btn"
          @click="changeToNow">此刻</a>
        <button
          type="button"
          class="b-picker-panel__btn"
...
<script>
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, BInput
    },
