<template>
  <transition
    ...
    <div
      ...
      class="b-time-range-picker b-picker-panel"
      :class="popperClass">
      <div class="b-time-range-picker__content">
        <div class="b-time-range-picker__cell">
          ...
          <div
            ...
            class="b-time-range-picker__body b-time-panel__content">
            <time-spinner
              ref="minSpinner"
      ...
      <div class="b-time-panel__footer">
        <button
          type="button"
          class="b-time-panel__btn cancel"
          @click="handleCancel()">取消</button>
        <button
          type="button"
          class="b-time-panel__btn confirm"
          @click="handleConfirm()"
