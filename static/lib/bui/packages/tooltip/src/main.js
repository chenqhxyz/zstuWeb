...
export default {
  ...
  render(h) {
    this.popperVM.node = (
      <transition
        ...
        <div
          ...
          class={
            ['b-tooltip__popper', this.popperClass]
          }>
    ...
    const vnode = this.$slots.default[this.$slots.default.length-1];
    ...
    data.staticClass = this.concatClass(data.staticClass, 'b-tooltip');
