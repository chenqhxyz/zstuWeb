...
const defaults = {
    ...
    selection: {
        ...
        realWidth: 48,
        order: '',
        className: 'b-table-column--selection'
    },
    expand: {
        width: 48,
        minWidth: 48,
...
const forced = {
    ...
    expand: {
        ...
        renderCell: function (h, {row, store}, proxy) {
            ...
            return <div class={ 'b-table__expand-icon ' + (expanded ? 'b-table__expand-icon--expanded' : '') }
        ...
        sortable: false,
        resizable: false,
        className: 'b-table__expand-column'
    }
};
...
export default {
    ...
    destroyed() {
        ...
        if(!this.hidden){
            owner.store.commit('removeColumn', this.columnConfig, this.isSubColumn ? parent.columnConfig : null);
        }
    },
