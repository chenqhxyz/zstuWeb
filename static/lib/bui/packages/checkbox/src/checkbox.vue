<template>
  <label class="b-checkbox">
    ...
    >
      <span class="b-checkbox__inner"></span>
      <input
    ...
    <span class="b-checkbox__label" v-if="!empty && ($slots.default || label)">
      <slot></slot>
...
<script type="text/babel">
  ...
  export default {
    ...
    computed: {
      model: {
        get() {
          return this.isGroup ? this._checkboxGroup.value : this.value !== undefined ? this.value : this.selfModel;
        },
