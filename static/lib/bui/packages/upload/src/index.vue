<script>
    ...
    export default {
        ...
        computed: {
            needList () {
                return this.showUploadList && this.fileList.length;
            }
        },
        ...
        render(h) {
            var props = {
                props: {
                    ...
                    name: this.name,
                    data: this.data,
                    accept: this.thumbnailMode || this.type.indexOf('image') > -1 ? 'image/gif, image/png, image/jpeg, image/bmp, image/webp' : this.accept,
            ...
            if (this.needList && this.type.indexOf('image') < 0 && this.thumbnailMode) {
                uploadList = (
                        <CoverList
                                files={this.fileList}
                                on-remove={this.handleRemove}>
            ...
            } else if(this.needList && this.type.indexOf('image') < 0) {
                uploadList = (
                        <UploadList
                                files={this.fileList}
                                on-remove={this.handleRemove}
